...
/**
  * @brief this function is used to put the message in a mailbox to be transmitted
  * @param None
  * @retval None
  */
void CAN1_TX(void) {
	//The header of the message to be transmitted.
	...
	//this variable will store the number of MailBox chosen to transmit the message
	uint32_t TxMailBox;
